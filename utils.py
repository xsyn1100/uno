...
def display_color(color):
    ...
    if color == "r":
        return _("{emoji} Kırmızı").format(emoji='❤️')
    if color == "b":
        return _("{emoji} Mavi").format(emoji='💙')
    if color == "g":
        return _("{emoji} Yeşil").format(emoji='💚')
    if color == "y":
...
def display_color_group(color, game):
    """ Convert a color code to actual color name """
    if color == "r":
        return __("{emoji} Kırmızı", game.translate).format(
            emoji='❤️')
    if color == "b":
        return __("{emoji} Mavi", game.translate).format(
            emoji='💙')
    if color == "g":
        return __("{emoji} Yeşil", game.translate).format(
            emoji='💚')
    if color == "y":
